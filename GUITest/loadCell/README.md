...
```
Had problems installing and setting up load cell on personal Linux machine, might not be the case on rasberry pi. Should be able to run commands without sudo.
